...
public class RegisterClient {
	...
	// 获得Post请求对象request
			...
			public static String queryStringForPost(String username,String phonenumber,String password,String url) throws UnsupportedEncodingException {
				// 根据url获得HttpPost对象
