...
public class ResetPasswordClient {
	...
	public static String queryStringForPost(String phonenumber,String password,String url) throws UnsupportedEncodingException {
		// 根据url获得HttpPost对象
		...
		//防止中文乱码
		phonenumber=URLEncoder.encode(URLEncoder.encode(phonenumber, "UTF-8"), "UTF-8");
		//添加用户名和密码
